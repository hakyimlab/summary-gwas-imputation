...
def load_gtex_variant_to_rsid(path, dbsnp_column = "rs_id_dbSNP150_GRCh38p7"):
    return KeyedDataSource.load_data(path, "variant_id", dbsnp_column, should_skip=(lambda k,v: v == "."))
